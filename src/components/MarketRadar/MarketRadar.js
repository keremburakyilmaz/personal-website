...
export default function MarketRadar() {
  ...
  return (
    <section className="market-radar-section">
      {bannerVisible && (
        <div className="mr-construction-banner">
          <div className="mr-construction-content">
            <span className="mr-construction-icon">
            ...
            <div>
              ...
              <span className="mr-construction-detail">
                This page uses mock data for demonstration purposes. Live market feeds are not yet connected.
              </span>
            </div>
          </div>
          <button className="mr-construction-close" onClick={() => setBannerVisible(false)} aria-label="Dismiss">
